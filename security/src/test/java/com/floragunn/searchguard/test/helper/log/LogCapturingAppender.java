/*
 * Based on https://github.com/opensearch-project/security/blob/3.2.0.0/src/integrationTest/java/org/opensearch/test/framework/log/LogCapturingAppender.java
...
import static com.floragunn.searchguard.test.helper.log.LogCapturingAppender.PLUGIN_NAME;
