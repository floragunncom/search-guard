...
public class IgnoreUnauthorizedCcsIntTest {
    ...
    private static TestSgConfig.User LIMITED_USER_COORD_A = new TestSgConfig.User("limited_user_A").roles(//
            new Role("limited_user_a_role").clusterPermissions("SGS_CLUSTER_COMPOSITE_OPS_RO").indexPermissions("SGS_CRUD").on("a*"));

    private static TestSgConfig.User LIMITED_USER_REMOTE_A = new TestSgConfig.User("limited_user_A").roles(//
    ...
    private static TestSgConfig.User LIMITED_USER_COORD_B = new TestSgConfig.User("limited_user_B").roles(//
            new Role("limited_user_b_role").clusterPermissions("SGS_CLUSTER_COMPOSITE_OPS_RO").indexPermissions("SGS_CRUD").on("b*"));

    private static TestSgConfig.User LIMITED_USER_REMOTE_B = new TestSgConfig.User("limited_user_B").roles(//
    ...
    private static TestSgConfig.User UNLIMITED_USER = new TestSgConfig.User("unlimited_user").roles(//
    ...
    @ClassRule
    public static TestIndex index_coord_a1 = TestIndex.name("a1").documentCount(100).seed(1).attr("prefix", "a").attr("cluster", "local")
            .cluster(cluster).build();

    @ClassRule
    public static TestIndex index_coord_a2 = TestIndex.name("a2").documentCount(110).seed(2).attr("prefix", "a").attr("cluster", "local")
            .cluster(cluster).build();

    @ClassRule
    public static TestIndex index_remote_a1 = TestIndex.name("a1").documentCount(120).seed(11).attr("prefix", "a").attr("cluster", "remote")
            .cluster(anotherCluster).build();

    @ClassRule
    public static TestIndex index_remote_a2 = TestIndex.name("a2").documentCount(130).seed(12).attr("prefix", "a").attr("cluster", "remote")
            .cluster(anotherCluster).build();

    @ClassRule
    public static TestIndex index_coord_b1 = TestIndex.name("b1").documentCount(51).seed(4).attr("prefix", "b").attr("cluster", "local")
            .cluster(cluster).build();

    @ClassRule
    public static TestIndex index_coord_b2 = TestIndex.name("b2").documentCount(52).seed(5).attr("prefix", "b").attr("cluster", "local")
            .cluster(cluster).build();

    @ClassRule
    public static TestIndex index_remote_b1 = TestIndex.name("b1").documentCount(53).seed(14).attr("prefix", "b").attr("cluster", "remote")
            .cluster(anotherCluster).build();

    @ClassRule
    public static TestIndex index_remote_b2 = TestIndex.name("b2").documentCount(54).seed(15).attr("prefix", "b").attr("cluster", "remote")
            .cluster(anotherCluster).build();

    @ClassRule
    public static TestIndex index_coord_c1 = TestIndex.name("c1").documentCount(5).seed(7).attr("prefix", "c").attr("cluster", "local")
            .cluster(cluster).build();

    @ClassRule
    public static TestIndex index_remote_r1 = TestIndex.name("r1").documentCount(5).seed(8).attr("prefix", "r").attr("cluster", "remote")
            .cluster(anotherCluster).build();

    @ClassRule
    public static TestAlias xalias_coord_ab1 = new TestAlias("xalias_ab1", cluster, index_coord_a1, index_coord_a2, index_coord_b1);

    @ClassRule
    public static TestAlias xalias_remote_ab1 = new TestAlias("xalias_ab1", anotherCluster, index_remote_a1, index_remote_a2, index_remote_b1);
