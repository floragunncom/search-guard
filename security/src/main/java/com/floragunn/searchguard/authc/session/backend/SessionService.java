...
public class SessionService {
    ...
    private void authenticate(Map<String, Object> request, RestRequest restRequest, List<String> requiredLoginPrivileges,
        ...
        new ApiAuthenticationProcessor(request, requestMetaData, threadContext, apiAuthenticationDomains, adminDns, privilegesEvaluator,
                auditLog, authBackendFailureListeners, blockedUserRegistry, ipAuthFailureListeners, requiredLoginPrivileges,
                authczConfig.isDebugEnabled(configId)).authenticate(onResult, onFailure);
