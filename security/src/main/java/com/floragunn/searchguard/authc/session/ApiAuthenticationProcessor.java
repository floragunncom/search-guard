...
public class ApiAuthenticationProcessor extends RequestAuthenticationProcessor<ApiAuthenticationFrontend> {
    ...
    public ApiAuthenticationProcessor(Map<String, Object> request, RequestMetaData<RestRequest> requestMetaData, ThreadContext threadContext,
            ...
            PrivilegesEvaluator privilegesEvaluator, AuditLog auditLog, Multimap<String, AuthFailureListener> authBackendFailureListeners,
            ...
            boolean debug) {
        super(requestMetaData, threadContext, authenticationDomains, adminDns, privilegesEvaluator, null, null, auditLog, authBackendFailureListeners,
