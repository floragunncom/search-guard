...
// Source:
// https://github.com/groovenauts/jmeter_oauth_plugin/blob/master/jmeter/src/main/java/org/apache/jmeter/protocol/oauth/sampler/PrivateKeyReader.java
// https://github.com/mendix/SSLTools/blob/master/src/main/java/com/mendix/ssltools/PrivateKeyReader.java
...
// Stripped and slightly modified
...
class PKCS1Reader {
	     ...
	     */
	    public PKCS1Reader(byte[] encodedKey) {
	    ...
	    public PrivateKey read() throws IOException {
            ...
            RSAPrivateCrtKeySpec keySpec = getRSAKeySpec(encodedKey);
