...
public class PermissionAction extends BaseRestHandler {
    ...
    public PermissionAction(final Settings settings, final RestController controller, final PrivilegesEvaluator evaluator,
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        return new RestChannelConsumer() {
            ...
            public void accept(RestChannel channel) throws Exception {
                ...
                TransportAddress caller = Objects.requireNonNull((TransportAddress) threadContext.getTransient(ConfigConstants.SG_REMOTE_ADDRESS));

                Map<String, Boolean> evaluationResult = evaluator.evaluateClusterAndTenantPrivileges(user, caller, permissions);
