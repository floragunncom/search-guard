...
public class SearchGuardWhoAmIAction extends BaseRestHandler {
    ...
    public SearchGuardWhoAmIAction(final Settings settings, final AdminDNs adminDns, ThreadPool threadPool) {
        super();
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        return channel -> {
            ...
            final String dn = threadPool.getThreadContext().getTransient(SSLConfigConstants.SG_SSL_PRINCIPAL);
