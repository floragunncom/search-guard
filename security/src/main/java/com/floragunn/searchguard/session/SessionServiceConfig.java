...
public class SessionServiceConfig {
    ...
    public static SessionServiceConfig parse(Map<String, Object> jsonNode, SecretsService secretsStorageService)
    ...
    public static SessionServiceConfig parseYaml(String yaml, SecretsService secretsStorageService) throws ConfigValidationException {
