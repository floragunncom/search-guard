...
public class Actions {
    ...
    public Actions(SearchGuardModulesRegistry modulesRegistry) {
        ...
        index(TransportIndexAction.TYPE); //todo #103055
        index(TransportGetAction.TYPE); //todo #103055
        index(TermVectorsAction.INSTANCE); //todo #103055
        index(TransportDeleteAction.TYPE); //todo #103055
        index(TransportUpdateAction.TYPE); //todo #103055
        ...
        cluster(TransportMultiGetAction.TYPE); //todo #103055
        cluster(TransportBulkAction.TYPE);
        ...
        index(TransportIndicesShardStoresAction.TYPE); //todo #103716
        index(TransportCreateIndexAction.TYPE) //
        ...
        index(TransportDeleteIndexAction.TYPE); //todo #103242
        index(GetIndexAction.INSTANCE);
        index(OpenIndexAction.INSTANCE);
        index(TransportCloseIndexAction.TYPE); //todo #103055
        index(TransportAddIndexBlockAction.TYPE);
        index(GetMappingsAction.INSTANCE);
        index(GetFieldMappingsAction.INSTANCE);
        index(TransportPutMappingAction.TYPE); //todo #103330
        index(TransportAutoPutMappingAction.TYPE); //todo #103330

        index(TransportIndicesAliasesAction.TYPE) // //todo #103055
        ...
        index(TransportUpdateSettingsAction.TYPE); //todo #103330
        ...
        cluster(TransportNodesReloadSecureSettingsAction.TYPE); //todo #103734
        ...
        cluster(TransportGetTaskAction.TYPE);
        cluster(TransportCancelTasksAction.TYPE);

        cluster(TransportAddVotingConfigExclusionsAction.TYPE); //todo #103242
        cluster(TransportClearVotingConfigExclusionsAction.TYPE); //todo #103242
        cluster(TransportClusterAllocationExplainAction.TYPE); //todo #103242
        cluster(ClusterStatsAction.INSTANCE);
        cluster(ClusterStateAction.INSTANCE);
        cluster(TransportClusterHealthAction.TYPE); //todo #103055
        cluster(ClusterUpdateSettingsAction.INSTANCE);
        cluster(ClusterRerouteAction.INSTANCE);
        cluster(TransportPendingClusterTasksAction.TYPE); //todo #103055
        cluster(TransportPutRepositoryAction.TYPE); //todo #103242
        cluster(GetRepositoriesAction.INSTANCE);
        cluster(TransportDeleteRepositoryAction.TYPE); //todo #103242
        cluster(VerifyRepositoryAction.INSTANCE);
        cluster(TransportCleanupRepositoryAction.TYPE);
        cluster(GetSnapshotsAction.INSTANCE);
        cluster(TransportDeleteSnapshotAction.TYPE); //todo #103242
        cluster(CreateSnapshotAction.INSTANCE);
        cluster(TransportCloneSnapshotAction.TYPE); //todo #103242
        ...
        cluster(TransportPutIndexTemplateAction.TYPE); //todo #103330
        cluster(GetIndexTemplatesAction.INSTANCE);
        cluster(TransportDeleteIndexTemplateAction.TYPE); //todo #103330
        cluster(PutComponentTemplateAction.INSTANCE);
        cluster(GetComponentTemplateAction.INSTANCE);
        cluster(TransportDeleteComponentTemplateAction.TYPE); //todo #104024
        cluster(TransportPutComposableIndexTemplateAction.TYPE); //todo #104024
        cluster(GetComposableIndexTemplateAction.INSTANCE);
        cluster(TransportDeleteComposableIndexTemplateAction.TYPE); //todo #104024
        ...
        index(TransportClearIndicesCacheAction.TYPE);

        index(GetAliasesAction.INSTANCE);
        index(GetSettingsAction.INSTANCE);

        index(TransportFieldCapabilitiesAction.TYPE); //todo #103055

        cluster(TransportPutStoredScriptAction.TYPE); //todo #103242
        cluster(GetStoredScriptAction.INSTANCE);
        cluster(TransportDeleteStoredScriptAction.TYPE); //todo #103242
        cluster(GetScriptContextAction.INSTANCE);
        cluster(GetScriptLanguageAction.INSTANCE);

        cluster(PutPipelineTransportAction.TYPE); //todo #103330
        cluster(GetPipelineAction.INSTANCE);
        cluster(DeletePipelineTransportAction.TYPE); //todo #103330
        ...
        cluster(TransportListDanglingIndicesAction.TYPE); //todo #103452
        cluster(TransportImportDanglingIndexAction.TYPE); //todo #103452
        cluster(TransportDeleteDanglingIndexAction.TYPE); //todo #103242
        cluster(TransportFindDanglingIndexAction.TYPE); //todo #103452

        cluster(TransportNodesSnapshotsStatus.ACTION_NAME);

        open(RetentionLeaseActions.ADD); //todo #103242
        open(RetentionLeaseActions.RENEW); //todo #103242
        open(RetentionLeaseActions.REMOVE); //todo #103242
