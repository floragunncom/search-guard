...
public class ConfigV7 {
    ...
    public static class AuthcDomain {
        ...
        public AuthcDomain(com.floragunn.searchguard.sgconf.impl.v6.ConfigV6.AuthcDomain v6) {
            super();
...
//            }
    ...
    public static class HttpAuthenticator {
        ...
        public HttpAuthenticator(com.floragunn.searchguard.sgconf.impl.v6.ConfigV6.HttpAuthenticator v6) {
    ...
    public static class AuthzBackend {
        ...
        public AuthzBackend(com.floragunn.searchguard.sgconf.impl.v6.ConfigV6.AuthzBackend v6) {
            this.type = v6.type;
            this.config = v6.config;
        }
    ...
    public static class AuthcBackend {
        ...
        public AuthcBackend(com.floragunn.searchguard.sgconf.impl.v6.ConfigV6.AuthcBackend v6) {
            this.type = v6.type;
            this.config = v6.config;
        }
