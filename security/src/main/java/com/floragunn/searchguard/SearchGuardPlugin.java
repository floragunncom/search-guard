    ...
    public List<ActionFilter> getActionFilters() {
        ...
        if (!client && !disabled && !sslOnly) {
            ...
            SearchGuardFilter searchGuardFilter = new SearchGuardFilter(authorizationService, evaluator, adminDns,
                    ...
                    actionRequestIntrospector, specialPrivilegesEvaluationContextProviderRegistry, extendedActionHandlingService, xContentRegistry, indexNameExpressionResolver);
