...
public class JwtVerifier {
    ...
    public JWT getVerfiedJwt(String encodedJwt) throws ParseException, JOSEException, BadJWTException {
        return getVerfiedJwt(encodedJwt, this.jwtClaimsVerifier);
    }
    
    public JWT getVerfiedJwt(String encodedJwt, String requiredAudience) throws ParseException, JOSEException, BadJWTException {
        return getVerfiedJwt(encodedJwt, new DefaultJWTClaimsVerifier<>(requiredAudience, null, null));        
    }
    
    private JWT getVerfiedJwt(String encodedJwt, JWTClaimsSetVerifier<SecurityContext> jwtClaimsVerifier) throws ParseException, JOSEException, BadJWTException {
    ...
    static class CxfBased {
        ...
        JWT getVerifiedJwt(String encodedJwt) {
            ...
            return new SignedJWT(cxfHeaderToNimbusHeader(jwt.getJwsHeaders()), cxfClaimsToNimbusClaims(jwt.getClaims()));
        }
