...
public class InvalidRolesAndMappingConfigurationTest {
    ...
    public void shouldReportConfigurationErrorWhenRoleContainsInvalidIndexPattern() throws Exception {
        ...
        assertThatSearchIsRejectedDueToIncorrectRoleConfiguration(response);
    }
    ...
    public void shouldReportConfigurationErrorWhenMappingContainInvalidPatternInBackendRoleName() throws Exception {
        ...
        assertThatSearchIsRejectedDueToIncorrectRoleMappingConfiguration(response);
    }
    ...
    private static void assertThatSearchIsRejectedDueToIncorrectRoleConfiguration(HttpResponse response) throws Exception {
    ...
    private static void assertThatSearchIsRejectedDueToIncorrectRoleMappingConfiguration(
        ...
        assertThat(body, containsValue("$.error.type", ERROR_TYPE));
        assertThat(body,//
            containSubstring("$.error.reason", "Incorrect configuration of SearchGuard roles or roles mapping, please check the log file for more details."));
    }
