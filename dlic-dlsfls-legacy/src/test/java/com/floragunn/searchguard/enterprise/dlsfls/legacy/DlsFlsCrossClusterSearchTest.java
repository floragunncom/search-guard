...
public class DlsFlsCrossClusterSearchTest extends AbstractSGUnitTest {
    ...
    public void testCcs() throws Exception {
        ...
        try (Client tc = cl2.nodeClient()) {
            ...
            tc.index(new IndexRequest("humanresources").setRefreshPolicy(RefreshPolicy.IMMEDIATE).id("0")
                    .source("{\"cluster\": \"" + cl2Info.clustername + "\"," + "\"Designation\": \"CEO\"," + "\"FirstName\": \"__fn__"
                            + cl2Info.clustername + "\"," + "\"LastName\": \"lastname0\"," + "\"Salary\": \"salary0\","
                            + "\"SecretFiled\": \"secret0\"," + "\"AnotherSecredField\": \"anothersecret0\"," + "\"XXX\": \"xxx0\"" + "}",
                            XContentType.JSON))
                    .actionGet();

            tc.index(new IndexRequest("humanresources").setRefreshPolicy(RefreshPolicy.IMMEDIATE).id("1")
                    .source("{\"cluster\": \"" + cl2Info.clustername + "\"," + "\"Designation\": \"someoneelse\"," + "\"FirstName\": \"__fn__"
                            + cl2Info.clustername + "\"," + "\"LastName\": \"lastname1\"," + "\"Salary\": \"salary1\","
                            + "\"SecretFiled\": \"secret1\"," + "\"AnotherSecredField\": \"anothersecret1\"," + "\"XXX\": \"xxx1\"" + "}",
                            XContentType.JSON))
                    .actionGet();
    ...
    public void testCcsDifferentConfigBoth() throws Exception {
        ...
        try (Client tc = cl1.nodeClient()) {
            ...
            tc.index(new IndexRequest("humanresources").setRefreshPolicy(RefreshPolicy.IMMEDIATE).id("0")
                    .source("{\"cluster\": \"" + cl1Info.clustername + "\"," + "\"Designation\": \"CEO\"," + "\"FirstName\": \"__fn__"
                            + cl1Info.clustername + "\"," + "\"LastName\": \"lastname0\"," + "\"Salary\": \"salary0\","
                            + "\"SecretFiled\": \"secret3\"," + "\"AnotherSecredField\": \"anothersecret3\"," + "\"XXX\": \"xxx0\"" + "}",
                            XContentType.JSON))
                    .actionGet();

            tc.index(new IndexRequest("humanresources").setRefreshPolicy(RefreshPolicy.IMMEDIATE).id("1")
                    .source("{\"cluster\": \"" + cl1Info.clustername + "\"," + "\"Designation\": \"someoneelse\"," + "\"FirstName\": \"__fn__"
                            + cl1Info.clustername + "\"," + "\"LastName\": \"lastname1\"," + "\"Salary\": \"salary1\","
                            + "\"SecretFiled\": \"secret4\"," + "\"AnotherSecredField\": \"anothersecret4\"," + "\"XXX\": \"xxx1\"" + "}",
                            XContentType.JSON))
                    .actionGet();
        }
