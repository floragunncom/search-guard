...
public class DlsRestriction {
    ...
    public BooleanQuery.Builder toQueryBuilder(QueryShardContext searchExecutionContext, Function<Query, Query> queryMapFunction) {
        if (this.queries.isEmpty()) {
            return null;
        }

        boolean hasNestedMapping = searchExecutionContext.getMapperService().hasNested();
