...
public class DlsFlsConfigApi extends TypeLevelConfigApi {
    ...
    public static final RestApi REST_API = new RestApi()//
            .handlesGet("/_searchguard/config/authz_dlsfls").with(GetAction.INSTANCE)//
            .handlesPut("/_searchguard/config/authz_dlsfls").with(PutAction.INSTANCE, (params, body) -> new PutAction.Request(body.parseAsMap()))//
    ...
    public static class GetAction extends TypeLevelConfigApi.GetAction {
        ...
        public static class Handler extends TypeLevelConfigApi.GetAction.Handler<DlsFlsConfig> {
            ...
            public Handler(HandlerDependencies handlerDependencies, ConfigurationRepository configurationRepository,
                ...
                super(INSTANCE, DlsFlsConfig.TYPE, handlerDependencies, configurationRepository, baseDependencies);
            }
        }
    ...
    public static class PutAction extends TypeLevelConfigApi.PutAction {
        ...
        public static class Handler extends TypeLevelConfigApi.PutAction.Handler<DlsFlsConfig> {
            @Inject
            public Handler(HandlerDependencies handlerDependencies, ConfigurationRepository configurationRepository) {
                super(INSTANCE, DlsFlsConfig.TYPE, handlerDependencies, configurationRepository);
            }
        }
    }
