...
public class EnableGenericWatchInstanceAction extends Action<EnableGenericWatchInstanceAction.EnableGenericWatchInstanceRequest, StandardResponse> {
    ...
    public static class EnableGenericWatchInstanceHandler extends StandardSyncOperationHandler<EnableGenericWatchInstanceRequest> {
        ...
        @Override
        protected StandardResponse synchronousExecute(EnableGenericWatchInstanceRequest request) {
            return genericWatchService.switchEnabledFlag(request.getTenantId(), request.getWatchId(), request.getInstanceId(), true);
        }
    }
