...
import com.floragunn.signals.NotAcknowledgableException;
...
public class TransportAckWatchAction
    ...
    protected NodeResponse nodeOperation(final NodeRequest request) {
        ...
        } catch (NotAcknowledgableException e) {
            return new NodeResponse(clusterService.localNode(), AckWatchResponse.Status.NOT_ACKNOWLEDGABLE, e.getMessage());            
        } catch (Exception e) {
