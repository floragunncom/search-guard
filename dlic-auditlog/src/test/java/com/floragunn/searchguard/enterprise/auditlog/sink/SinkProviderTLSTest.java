...
public class SinkProviderTLSTest {
    ...
    public void testTlsConfigurationNoFallback() throws Exception {
        ...
        server = ServerBootstrap.bootstrap().setListenerPort(8083).setServerInfo("Test/1.1").setSslContext(createSSLContext())
        ...
        builder.put("searchguard.audit.config.webhook.ssl.pemtrustedcas_filepath",
                FileHelper.getAbsoluteFilePathFromClassPath("auditlog/root-ca.pem"));
        builder.put("searchguard.audit.endpoints.endpoint1.config.webhook.ssl.pemtrustedcas_filepath",
                FileHelper.getAbsoluteFilePathFromClassPath("auditlog/root-ca.pem"));
