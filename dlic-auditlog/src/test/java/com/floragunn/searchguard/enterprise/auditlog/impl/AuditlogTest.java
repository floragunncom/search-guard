...
public class AuditlogTest {
    ...
    public void testCreateIndexRequest_requestBodyFieldIsFilledInCorrectly() throws Exception {
        ...
        DocNode indexAliases = DocNode.of("alias2", DocNode.of("filter", DocNode.of("term", DocNode.of("doc", "1")), "index_routing", "shard1", "is_write_index", false));
        String cause = "cause";
        String origin = "origin";
        CreateIndexRequest request = new CreateIndexRequest(indexName)
                .settings(indexSettings)
                .mapping("_doc", indexMappings)
        ...
        try (AbstractAuditLog al = new AuditLogImpl(settings, null, null, AbstractSGUnitTest.MOCK_POOL, null, cs, configurationRepository)) {
            ...
            Assert.assertEquals(DocNode.of("_doc", indexMappings.toJsonString()).toJsonString(), requestBody.getAsNode("mappings").toJsonString());
