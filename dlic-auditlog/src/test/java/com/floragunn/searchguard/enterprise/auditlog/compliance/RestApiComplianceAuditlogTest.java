...
public class RestApiComplianceAuditlogTest extends AbstractAuditlogiUnitTest {
    ...
    public void testRestApiRolesEnabled() throws Exception {
        ...
        Settings additionalSettings = Settings.builder().put("searchguard.audit.type", TestAuditlogImpl.class.getName())
                .put(ConfigConstants.SEARCHGUARD_RESTAPI_ROLES_ENABLED, "sg_all_access").put(ConfigConstants.SEARCHGUARD_AUDIT_ENABLE_TRANSPORT, true)
                .put(ConfigConstants.SEARCHGUARD_AUDIT_ENABLE_REST, true).put(ConfigConstants.SEARCHGUARD_AUDIT_RESOLVE_BULK_REQUESTS, false)
    ...
    public void testRestApiNewUser() throws Exception {
        ...
        Settings additionalSettings = Settings.builder().put("searchguard.audit.type", TestAuditlogImpl.class.getName())
                ...
                .put(ConfigConstants.SEARCHGUARD_COMPLIANCE_HISTORY_EXTERNAL_CONFIG_ENABLED, false)
                .put(ConfigConstants.SEARCHGUARD_COMPLIANCE_HISTORY_INTERNAL_CONFIG_ENABLED, true)
                .put(ConfigConstants.SEARCHGUARD_COMPLIANCE_HISTORY_WRITE_IGNORE_USERS, "admin").put("searchguard.audit.threadpool.size", 0).build();
