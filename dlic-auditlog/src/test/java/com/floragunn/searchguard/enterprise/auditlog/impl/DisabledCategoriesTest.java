...
public class DisabledCategoriesTest {
    ...
    protected void logRestSucceededLogin(AuditLog auditLog) {
        auditLog.logSucceededLogin(UserInformation.forName("testuser.rest.succeededlogin"), false,
                UserInformation.forName("testuser.rest.succeededlogin"), new MockRestRequest());
    }

    protected void logTransportSucceededLogin(AuditLog auditLog) {
        auditLog.logSucceededLogin(UserInformation.forName("testuser.transport.succeededlogin"), false,
                UserInformation.forName("testuser.transport.succeededlogin"), new TransportRequest.Empty(), "test/action",
                new Task(0, "x", "ac", "", null, null));
    }

    protected void logRestFailedLogin(AuditLog auditLog) {
        auditLog.logFailedLogin(UserInformation.forName("testuser.rest.failedlogin"), false, UserInformation.forName("testuser.rest.failedlogin"),
                new MockRestRequest());
    }

    protected void logTransportFailedLogin(AuditLog auditLog) {
        auditLog.logFailedLogin(UserInformation.forName("testuser.transport.failedlogin"), false,
                UserInformation.forName("testuser.transport.failedlogin"), new TransportRequest.Empty(), null);
    }
