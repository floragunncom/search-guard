...
public class SSLAuditlogTest extends AbstractAuditlogiUnitTest {
    ...
    private void setupMonitoring() throws Exception {
        monitoringClusterInfo = monitoringCluster.startCluster(minimumSearchGuardSettings(defaultNodeSettings(Settings.EMPTY)),
    ...
    public void testExternalPemUserPass() throws Exception {
        ...
        Settings additionalSettings = Settings.builder().put("searchguard.audit.type", "external_elasticsearch")
                ...
                .put(ConfigConstants.SEARCHGUARD_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SEARCHGUARD_AUDIT_EXTERNAL_ES_ENABLE_SSL_CLIENT_AUTH,
                        false)
                ...
                .put(ConfigConstants.SEARCHGUARD_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SEARCHGUARD_AUDIT_EXTERNAL_ES_USERNAME, "admin")
                .put(ConfigConstants.SEARCHGUARD_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SEARCHGUARD_AUDIT_EXTERNAL_ES_PASSWORD, "admin")
                .build();
