...
public class WebhookAuditLogTest {
    ...
    public void invalidConfFallbackTest() throws Exception {
        ...
        Settings settings = Settings.builder().put("path.home", ".")
                .put("searchguard.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks")).build();
    ...
    public void formatsTest() throws Exception {
        ...
        Settings settings = Settings.builder().put("searchguard.audit.config.webhook.url", url).put("path.home", ".")
        ...
        settings = Settings.builder().put("searchguard.audit.config.webhook.url", url).put("searchguard.audit.config.webhook.format", "idonotexist")
                .put("searchguard.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks"))
                .put("path.home", ".").build();
        ...
        // TEXT
        settings = Settings.builder().put("searchguard.audit.config.webhook.url", url).put("searchguard.audit.config.webhook.format", "text")
                .put("searchguard.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks"))
                .put("path.home", ".").build();
        auditlog = new MockWebhookAuditLog(settings, ConfigConstants.SEARCHGUARD_AUDIT_CONFIG_DEFAULT, null);
        auditlog.store(msg);
        ...
        // JSON
        settings = Settings.builder().put("searchguard.audit.config.webhook.url", url).put("searchguard.audit.config.webhook.format", "json")
                .put("searchguard.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks"))
                .put("path.home", ".").build();
        auditlog = new MockWebhookAuditLog(settings, ConfigConstants.SEARCHGUARD_AUDIT_CONFIG_DEFAULT, null);
        auditlog.store(msg);
        ...
        // SLACK
        settings = Settings.builder().put("searchguard.audit.config.webhook.url", url).put("searchguard.audit.config.webhook.format", "slack")
                .put("searchguard.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks"))
                .put("path.home", ".").build();
        auditlog = new MockWebhookAuditLog(settings, ConfigConstants.SEARCHGUARD_AUDIT_CONFIG_DEFAULT, null);
        auditlog.store(msg);
    ...
    public void invalidUrlTest() throws Exception {
        ...
        final Settings settings = Settings.builder().put("searchguard.audit.config.webhook.url", url)
    ...
    public void noServerRunningHttpTest() throws Exception {
        ...
        Settings settings = Settings.builder().put("searchguard.audit.config.webhook.url", url)
                .put("searchguard.audit.config.webhook.format", "slack")
                .put("searchguard.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks"))
                .put("path.home", ".").build();
    ...
    public void postGetHttpTest() throws Exception {
        ...
        server = ServerBootstrap.bootstrap().setListenerPort(port).setServerInfo("Test/1.1").registerHandler("*", handler).create();
        ...
        // SLACK
        Settings settings = Settings.builder().put("searchguard.audit.config.webhook.url", url)
                .put("searchguard.audit.config.webhook.format", "slack").put("path.home", ".")
                .put("searchguard.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks")).build();
        ...
        // URL POST
        settings = Settings.builder().put("searchguard.audit.config.webhook.url", url)
                .put("searchguard.audit.config.webhook.format", "URL_PARAMETER_POST").put("path.home", ".")
                .put("searchguard.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks")).build();
        ...
        // URL GET
        settings = Settings.builder().put("searchguard.audit.config.webhook.url", url)
                .put("searchguard.audit.config.webhook.format", "URL_PARAMETER_GET").put("path.home", ".")
                .put("searchguard.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks")).build();
    ...
    public void httpsTest() throws Exception {
        ...
        server = ServerBootstrap.bootstrap().setListenerPort(port).setServerInfo("Test/1.1").setSslContext(createSSLContext())
        ...
        Settings settings = Settings.builder().put("searchguard.audit.config.webhook.url", url)
                .put("searchguard.audit.config.webhook.format", "slack").put("path.home", ".")
                .put("searchguard.audit.config.webhook.ssl.verify", true).build();
        ...
        handler.reset();
        settings = Settings.builder().put("searchguard.audit.config.webhook.url", url).put("searchguard.audit.config.webhook.format", "jSoN")
                .put("searchguard.audit.config.webhook.ssl.verify", false).put("path.home", ".").build();
        auditlog = new WebhookSink("name", settings, ConfigConstants.SEARCHGUARD_AUDIT_CONFIG_DEFAULT, null, fallback);
        auditlog.store(msg);
        Assert.assertTrue(handler.method.equals("POST"));
        Assert.assertTrue(handler.body != null);
        ...
        settings = Settings.builder().put("searchguard.audit.config.webhook.url", url).put("searchguard.audit.config.webhook.format", "jSoN")
                .put("searchguard.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks"))
                .put("searchguard.audit.config.webhook.ssl.verify", true).put("path.home", ".").build();
        auditlog = new WebhookSink("name", settings, ConfigConstants.SEARCHGUARD_AUDIT_CONFIG_DEFAULT, null, fallback);
        auditlog.store(msg);
        Assert.assertTrue(handler.method.equals("POST"));
        Assert.assertTrue(handler.body != null);
    ...
    public void httpsTestPemDefault() throws Exception {
        ...
        handler.reset();
        Settings settings = Settings.builder().put("searchguard.audit.config.webhook.url", url).put("searchguard.audit.config.webhook.format", "jSoN")
        ...
        handler.reset();
        settings = Settings.builder().put("searchguard.audit.config.webhook.url", url)
                .put("searchguard.audit.config.webhook.ssl.pemtrustedcas_filepath", "wrong").put("searchguard.audit.config.webhook.format", "jSoN")
                .put("searchguard.audit.config.webhook.ssl.verify", true).put("path.home", ".").build();
        auditlog = new WebhookSink("name", settings, ConfigConstants.SEARCHGUARD_AUDIT_CONFIG_DEFAULT, null, fallback);
        auditlog.store(msg);
        Assert.assertNull(handler.method);
    ...
    public void httpsTestPemEndpoint() throws Exception {
        ...
        // test default with filepath
        handler.reset();
        Settings settings = Settings.builder().put("searchguard.audit.endpoints.endpoint1.config.webhook.url", url)
                .put("searchguard.audit.endpoints.endpoint1.config.webhook.format", "jSoN")
                .put("searchguard.audit.endpoints.endpoint1.config.webhook.ssl.pemtrustedcas_filepath",
                        FileHelper.getAbsoluteFilePathFromClassPath("auditlog/root-ca.pem"))
                .put("searchguard.audit.endpoints.endpoint1.config.webhook.ssl.verify", true).put("path.home", ".").build();
        ...
        // test default with missing filepath and fallback to correct SG settings
        handler.reset();
        settings = Settings.builder().put("searchguard.audit.endpoints.endpoint1.config.webhook.url", url)
                .put("searchguard.audit.endpoints.endpoint1.config.webhook.format", "jSoN")
