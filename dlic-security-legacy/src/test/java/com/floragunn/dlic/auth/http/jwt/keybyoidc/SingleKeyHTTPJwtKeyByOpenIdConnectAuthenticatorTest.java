...
public class SingleKeyHTTPJwtKeyByOpenIdConnectAuthenticatorTest {
    ...
    public void wrongSigTest() throws Exception {
        ...
        try {
            ...
            AuthCredentials creds = jwtAuth.extractCredentials(
                    new FakeRestRequest(ImmutableMap.of("Authorization", TestJwts.NoKid.MC_COY_SIGNED_RSA_X), new HashMap<String, String>()), null);
    ...
    public void mismatchedAlgTest() throws Exception {
        ...
        try {
            ...
            AuthCredentials creds = jwtAuth.extractCredentials(
                    new FakeRestRequest(ImmutableMap.of("Authorization", TestJwts.NoKid.MC_COY_SIGNED_RSA_1), new HashMap<String, String>()), null);
    ...
    public void keyExchangeTest() throws Exception {
        ...
        try {
            ...
            creds = jwtAuth.extractCredentials(
                    new FakeRestRequest(ImmutableMap.of("Authorization", TestJwts.NoKid.MC_COY_SIGNED_RSA_2), new HashMap<String, String>()), null);
        ...
        settings = Settings.builder().put("openid_connect_url", mockIdpServer.getDiscoverUri().toString()).build(); //port changed
