...
public class LdapBackendTestNewStyleConfig {
    ...
    public void testChainedLdapExists() throws Exception {
        ...
        final Settings settings = Settings.builder().putList(ConfigConstants.LDAP_HOSTS, "127.0.0.1:4", "localhost:" + plainTextLdapServer.getPort())
                .put("users.u1.search", "(uid={0})").put("users.u2.search", "(uid={0})").put("users.u2.base", "ou=people2,o=TEST").build();
    ...
    public void testChainedLdapAuthorization() throws Exception {
        ...
        final Settings settings = Settings.builder().putList(ConfigConstants.LDAP_HOSTS, "127.0.0.1:4", "localhost:" + plainTextLdapServer.getPort())
                .put("users.u1.search", "(uid={0})").put("users.u1.base", "ou=people,o=TEST").put(ConfigConstants.LDAP_AUTHZ_ROLENAME, "cn")
