...
public class LdapBackendTestClientCert {
    ...
    public void testBindDnAuthLocalhost() throws Exception {
        ...
        final LdapUser user = (LdapUser) new LDAPAuthenticationBackend(settings, null).authenticate(AuthCredentials.forUser("ldap_hr_employee").password("ldap_hr_employee").build());
