...
public class LdapBackendTestClientCert {
    ...
    public void testNoAuth() throws Exception {
        ...
        final Settings settings = Settings.builder().putList(ConfigConstants.LDAP_HOSTS, "localhost:636")
                ...
                .put(ConfigConstants.LDAP_AUTHC_USERBASE, "ou=people,dc=example,dc=com").put(ConfigConstants.LDAP_AUTHC_USERNAME_ATTRIBUTE, "uid")
                .put("path.home", ".").build();

        try {
            new LDAPAuthenticationBackend(settings, null)
                    .authenticate(AuthCredentials.forUser("ldap_hr_employee").password("ldap_hr_employee").build());
            Assert.fail();
        } catch (Exception e) {
            Assert.assertTrue(ExceptionUtils.getRootCause(e).getMessage(),
    ...
    public void testNoAuthX() throws Exception {
        ...
        final Settings settings = Settings.builder().putList(ConfigConstants.LDAP_HOSTS, "kdc.dummy.com:636")
                .put(ConfigConstants.LDAP_AUTHC_USERSEARCH, "(uid={0})").put(ConfigConstants.LDAPS_ENABLE_SSL, true)
                .put("searchguard.ssl.transport.truststore_filepath", "/Users/temp/search-guard-integration-tests/ldap/ssl-root-ca/truststore.jks")
                .put(ConfigConstants.LDAPS_VERIFY_HOSTNAMES, false).put(ConfigConstants.LDAP_AUTHC_USERBASE, "ou=people,dc=example,dc=com")
                .put(ConfigConstants.LDAP_AUTHC_USERNAME_ATTRIBUTE, "uid").put("path.home", ".").build();
    ...
    public void testNoAuthY() throws Exception {
        ...
        final Settings settings = Settings.builder().putList(ConfigConstants.LDAP_HOSTS, "kdc.dummy.com:636")
                ...
                .put("searchguard.ssl.transport.truststore_filepath",
                        "/Users/temp/search-guard-integration-tests/ldap/ssl-root-ca/wrong/truststore.jks")
                .put(ConfigConstants.LDAPS_VERIFY_HOSTNAMES, false).put(ConfigConstants.LDAP_AUTHC_USERBASE, "ou=people,dc=example,dc=com")
                .put(ConfigConstants.LDAP_AUTHC_USERNAME_ATTRIBUTE, "uid").put("path.home", ".").build();
    ...
    public void testBindDnAuthLocalhost() throws Exception {
        ...
        final Settings settings = Settings.builder().putList(ConfigConstants.LDAP_HOSTS, "localhost:636")
                ...
                .put("searchguard.ssl.transport.truststore_filepath", "/Users/temp/search-guard-integration-tests/ldap/ssl-root-ca/truststore.jks")
                .put(ConfigConstants.LDAP_AUTHC_USERBASE, "ou=people,dc=example,dc=com").put(ConfigConstants.LDAP_AUTHC_USERNAME_ATTRIBUTE, "uid")
                .put(ConfigConstants.LDAP_BIND_DN, "cn=ldapbinder,ou=people,dc=example,dc=com").put(ConfigConstants.LDAP_PASSWORD, "ldapbinder")
                .put("path.home", ".").build();
    ...
    public void testLdapSslAuth() throws Exception {
        ...
        final Settings settings = Settings.builder().putList(ConfigConstants.LDAP_HOSTS, "localhost:636")
                ...
                .put("searchguard.ssl.transport.truststore_filepath", "/Users/temp/search-guard-integration-tests/ldap/ssl-root-ca/truststore.jks")
                .put(ConfigConstants.LDAPS_ENABLE_SSL_CLIENT_AUTH, true).put(ConfigConstants.LDAPS_JKS_CERT_ALIAS, "spock")
                .put(ConfigConstants.LDAP_AUTHC_USERBASE, "ou=people,dc=example,dc=com").put(ConfigConstants.LDAP_AUTHC_USERNAME_ATTRIBUTE, "uid")
                .put("path.home", ".").build();
    ...
    public void testLdapSslAuthPem() throws Exception {
        ...
        final Settings settings = Settings.builder().putList(ConfigConstants.LDAP_HOSTS, "localhost:636")
                ...
                .put(ConfigConstants.LDAPS_ENABLE_SSL_CLIENT_AUTH, true).put(ConfigConstants.LDAP_AUTHC_USERBASE, "ou=people,dc=example,dc=com")
                .put(ConfigConstants.LDAP_AUTHC_USERNAME_ATTRIBUTE, "uid").put("path.home", ".")
    ...
    public void testLdapSslAuthNo() throws Exception {
        ...
        final Settings settings = Settings.builder().putList(ConfigConstants.LDAP_HOSTS, "localhost:636")
                ...
                .put("searchguard.ssl.transport.truststore_filepath", "/Users/temp/search-guard-integration-tests/ldap/ssl-root-ca/truststore.jks")
                .put(ConfigConstants.LDAPS_ENABLE_SSL_CLIENT_AUTH, true).put(ConfigConstants.LDAPS_JKS_CERT_ALIAS, "kirk")
                .put(ConfigConstants.LDAP_AUTHC_USERBASE, "ou=people,dc=example,dc=com").put(ConfigConstants.LDAP_AUTHC_USERNAME_ATTRIBUTE, "uid")
                .put("path.home", ".").build();
