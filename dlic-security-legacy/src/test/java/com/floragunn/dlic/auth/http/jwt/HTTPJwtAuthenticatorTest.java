...
public class HTTPJwtAuthenticatorTest {
    ...
    public void testNoKey() throws Exception {
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Leonard McCoy")
    ...
    public void testBearer() throws Exception {
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Leonard McCoy").setAudience("myaud")
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
    ...
    public void testRoles() throws Exception {
        Settings settings = Settings.builder().put("signing_key", BaseEncoding.base64().encode(secretKey)).put("roles_key", "roles").build();

        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Leonard McCoy").claim("roles", "role1,role2")
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
    ...
    public void testNullClaim() throws Exception {
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Leonard McCoy").claim("roles", null)
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
    ...
    public void testNonStringClaim() throws Exception {
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Leonard McCoy").claim("roles", 123L)
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
    ...
    public void testWrongSubjectKey() throws Exception {
        Settings settings = Settings.builder().put("signing_key", BaseEncoding.base64().encode(secretKey)).put("subject_key", "missing").build();

        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).claim("roles", "role1,role2").claim("asub", "Dr. Who")
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
    ...
    public void testAlternativeSubject() throws Exception {
        Settings settings = Settings.builder().put("signing_key", BaseEncoding.base64().encode(secretKey)).put("subject_key", "asub").build();

        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Leonard McCoy").claim("roles", "role1,role2")
                .claim("asub", "Dr. Who").signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
    ...
    public void testNonStringAlternativeSubject() throws Exception {
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Leonard McCoy").claim("roles", "role1,role2")
                .claim("asub", false).signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
    ...
    public void testUrlParam() throws Exception {
        Settings settings = Settings.builder().put("signing_key", BaseEncoding.base64().encode(secretKey)).put("jwt_url_parameter", "abc").build();
    ...
    public void testExp() throws Exception {
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Expired").setExpiration(new Date(100))
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
    ...
    public void testNbf() throws Exception {
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Expired")
                .setNotBefore(new Date(System.currentTimeMillis() + (1000 * 36000))).signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512)
                .compact();
    ...
    public void testRS256() throws Exception {
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Leonard McCoy").signWith(priv, SignatureAlgorithm.RS256)
                .compact();
        Settings settings = Settings.builder()
                .put("signing_key", "-----BEGIN PUBLIC KEY-----\n" + BaseEncoding.base64().encode(pub.getEncoded()) + "-----END PUBLIC KEY-----")
                .build();
    ...
    public void testES512() throws Exception {
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Leonard McCoy").signWith(priv, SignatureAlgorithm.ES512)
                .compact();
    ...
    public void rolesArray() throws Exception {
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer)
                .setPayload("{" + "\"sub\": \"John Doe\"," + "\"roles\": [\"a\",\"b\",\"3rd\"]" + "}")
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
    ...
    public void testJsonPathRolesAndSubjectExpression() {
        Settings settings = Settings.builder().put("signing_key", BaseEncoding.base64().encode(secretKey))
                .put("subject_path", "$['some_claim_name']['user']['id']").put("roles_path", "$['some_claim_name']['user']['roles']").build();
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).claim("some_claim_name", user)
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
    ...
    public void testJsonPathRolesAndSubjectExpressionWithInvalidRolePath() {
        Settings settings = Settings.builder().put("signing_key", BaseEncoding.base64().encode(secretKey))
                .put("subject_path", "$['some_claim_name']['user']['id']").put("roles_path", "$['some_claim_name']['asd']['roles']").build();
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).serializeToJsonWith(jwtSerializer).claim("some_claim_name", user)
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
    ...
    public void testInvalidJsonPathRolesAndSubjectExpression() {
        Settings settings = Settings.builder().put("signing_key", BaseEncoding.base64().encode(secretKey))
                .put("subject_path", "$['123123asd']['asdf']['id']").put("roles_path", "$['xyasd']['foo']['ss']").build();
    ...
    public void testIllegalJWTConfigurationDuplicateSubjects() {
        Settings settings = Settings.builder().put("signing_key", BaseEncoding.base64().encode(secretKey))
                .put("subject_path", "$['some_claim_name']['user']['id']").put("subject_key", "foo").build();
    ...
    public void testIllegalJWTConfigurationDuplicateRoleSpecification() {
        Settings settings = Settings.builder().put("signing_key", BaseEncoding.base64().encode(secretKey))
                .put("subject_path", "$['some_claim_name']['user']['id']").put("roles_path", "$['xyasd']['foo']['ss']").put("roles_key", "a, b, c")
                .build();
    ...
    public void attributeAsArray() throws Exception {
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setPayload("{" + "\"sub\": \"John Doe\"," //
    ...
    public void testSubjectPattern() throws Exception {
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("leonard@mccoy.com").setAudience("myaud")
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
    ...
    public void testRequiredAudience() {
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Leonard McCoy").setAudience("test_audience")
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
        ...
        jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Leonard McCoy").setAudience("wrong_audience")
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
        headers.put("Authorization", jwsToken);
    ...
    public void testRequiredIssuer() {
        ...
        String jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Leonard McCoy").setIssuer("test_issuer")
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
        ...
        jwsToken = Jwts.builder().serializeToJsonWith(jwtSerializer).setSubject("Leonard McCoy").setAudience("wrong_issuer")
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS512).compact();
        headers.put("Authorization", jwsToken);
