...
public class LdapUser extends User {
    ...
    public LdapUser(String name, AuthDomainInfo authDomainInfo, String originalUsername, final DirEntry userEntry, final AuthCredentials credentials,
    ...
    public static Map<String, String> extractLdapAttributes(String originalUsername, final DirEntry userEntry, int customAttrMaxValueLen,
