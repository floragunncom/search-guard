...
public class LDAPAuthenticationBackend implements LegacyAuthenticationBackend {
    ...
    static LdapEntry exists(final String user, Connection ldapConnection, Settings settings, List<Map.Entry<String, Settings>> userBaseSettings)
            throws Exception {
    ...
    private static LdapEntry existsSearchingUntilFirstHit(final String user, Connection ldapConnection,
        ...
        for (Map.Entry<String, Settings> entry : userBaseSettings) {
            ...
            List<LdapEntry> result = LdapHelper.search(ldapConnection, baseSettings.get(ConfigConstants.LDAP_AUTHCZ_BASE, DEFAULT_USERBASE), f,
                    SearchScope.SUBTREE);
    ...
    private static LdapEntry existsSearchingAllBases(final String user, Connection ldapConnection, List<Map.Entry<String, Settings>> userBaseSettings)
            throws Exception {
        final String username = user;
        ...
        for (Map.Entry<String, Settings> entry : userBaseSettings) {
            ...
            List<LdapEntry> foundEntries = LdapHelper.search(ldapConnection, baseSettings.get(ConfigConstants.LDAP_AUTHCZ_BASE, DEFAULT_USERBASE), f,
                    SearchScope.SUBTREE);
