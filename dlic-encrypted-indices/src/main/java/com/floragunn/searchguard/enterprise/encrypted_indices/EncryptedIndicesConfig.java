...
public class EncryptedIndicesConfig implements LicenseChangeListener {
    ...
    public EncryptedIndicesConfig(Environment environment, ConfigurationRepository configRepository) {
        super();
