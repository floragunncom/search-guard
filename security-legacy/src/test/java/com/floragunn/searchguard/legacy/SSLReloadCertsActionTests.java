    ...
    public void testReloadCa() throws Exception {
        ...
        try (GenericRestClient restClient = cluster.getAdminCertRestClient()) {
            ...
            String initialAndNewRootCa = String.join(
                    "\n",
                    FileUtils.readFileToString(initialRootCertificate.getCertificateFile(), StandardCharsets.UTF_8),
                    FileUtils.readFileToString(newRootCertificate.getCertificateFile(), StandardCharsets.UTF_8)
            );
