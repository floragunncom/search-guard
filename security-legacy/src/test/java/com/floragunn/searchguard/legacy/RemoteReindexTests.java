...
public class RemoteReindexTests extends AbstractSGUnitTest {
    ...
    public void testNonSSLReindex() throws Exception {
        ...
        String reindex = "{" + "\"source\": {" + "\"remote\": {" + "\"host\": \"http://" + cl2Info.httpHost + ":" + cl2Info.httpPort + "\","
                + "\"username\": \"nagilum\"," + "\"password\": \"nagilum\"" + "}," + "\"index\": \"twitter\"," + "\"size\": 10," + "\"query\": {"
                + "\"match\": {" + "\"_index\": \"twitter\"" + "}" + "}" + "}," + "\"dest\": {" + "\"index\": \"twutter\"" + "}" + "}";
        ...
        System.out.println("###################### reindex");
        ccs = new RestHelper(cl1Info, false, false, getResourceFolder()).executePostRequest("_reindex?pretty", reindex,
