...
public final class PemKeyReader {
    ...
    private static PrivateKey getPrivateKeyFromByteBuffer(InputStream in, String keyPassword)
    ...
    public static KeyStore toKeystore(final String authenticationCertificateAlias, final char[] password,
            final X509Certificate authenticationCertificate[], final PrivateKey authenticationKey) throws Exception {
