...
GROUP_ID="org.elasticsearch.painless"
VERSION="$1"
...
ARCH="darwin-x86_64" #arch does not matter, because we are only interested in .jar files
...
<project xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 https://maven.apache.org/xsd/maven-4.0.0.xsd" xmlns="http://maven.apache.org/POM/4.0.0"
  ...
  <groupId>org.elasticsearch.painless</groupId>
