...
import com.floragunn.searchguard.rest.validation.ActionGroupValidator;
...
public class ActionGroupsApiAction extends PatchableResourceApiAction {
	...
	@Inject
	public ActionGroupsApiAction(final Settings settings, final Path configPath,
                                 final AdminDNs adminDNs, final ConfigurationRepository cl, final ClusterService cs,
                                 final PrincipalExtractor principalExtractor, final PrivilegesEvaluator evaluator, ThreadPool threadPool, AuditLog auditLog, AdminDNs adminDns, ThreadContext threadContext) {
