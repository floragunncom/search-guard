...
final class DlsQueryParser {
    ...
    Query parseForWrapper(final Set<String> unparsedDlsQueries, final QueryShardContext queryShardContext)
            throws IOException {
    ...
    //can not handle tl queries
    ParsedQuery parseForValve(Set<String> unparsedDlsQueries, ParsedQuery originalQuery, QueryShardContext queryShardContext) throws IOException {
        if (unparsedDlsQueries == null || unparsedDlsQueries.isEmpty()) {
            return null;
        }
