...
public class AbstractTLQTest {
     ...
     * @param userCodes
     */
    protected void assertAccessCodesMatch(Map<String, Object> sourceMap, String accessCodesKey, Integer[] userCodes) {
     ...
     */
    protected void assertAccessCodesMatch(Collection<SearchHit> searchHits, Integer[] userCodes) {
     ...
     * @param userCodes
     */
    protected void assertAccessCodesMatch(SearchHit[] searchHits, Integer[] userCodes) {
     ...
     * @param buCode
     */
    protected void assertBuMatches(SearchHit searchHit, String buCode) {
     ...
     * @param buCode
     */
    protected void assertBuMatches(SearchHit[] searchHits, String buCode) {
     ...
     * @param clusterAlias
     */
    protected void assertAllHitsComeFromCluster(Collection<SearchHit> searchHits, String clusterAlias) {
    ...
    protected void assertAllHitsComeFromCluster(SearchHit[] searchHits, String clusterAlias) {        
        assertAllHitsComeFromCluster(Arrays.asList(searchHits), clusterAlias);
    }

    protected void assertAllHitsComeFromLocalCluster(SearchHit[] searchHits) {
        assertAllHitsComeFromLocalCluster(Arrays.asList(searchHits));
    }

    protected void assertAllHitsComeFromLocalCluster(Collection<SearchHit> searchHits) {
        for (SearchHit hit : searchHits) {
