...
public class SearchGuardApiAccessTest extends AbstractRestApiUnitTest {
    ...
    public void testRestApi() throws Exception {
        ...
        Assert.assertEquals(HttpStatus.SC_UNAUTHORIZED, rh.executeGetRequest("_searchguard/api/internalusers").getStatusCode());
        Assert.assertEquals(HttpStatus.SC_FORBIDDEN,
                rh.executeGetRequest("_searchguard/api/internalusers", encodeBasicHeader("admin", "admin")).getStatusCode());
