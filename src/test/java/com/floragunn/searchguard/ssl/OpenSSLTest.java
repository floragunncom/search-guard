...
public class OpenSSLTest extends SSLTest {
    ...
    public void testHttps() throws Exception {
        Assume.assumeTrue(SearchGuardSSLPlugin.OPENSSL_SUPPORTED && OpenSsl.isAvailable());
        super.testHttps();
    }
    ...
    public void testNodeClientSSLwithOpenSslTLSv13() throws Exception {
        ...
        Assume.assumeTrue(SearchGuardSSLPlugin.OPENSSL_SUPPORTED && OpenSsl.isAvailable() && OpenSsl.version() > 0x10101009L);
